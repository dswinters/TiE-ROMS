...
export        MY_ROOT_DIR=PLACEHOLDER
export     MY_PROJECT_DIR=PLACEHOLDER
...
# etc).
 ...
 export     MY_HEADER_DIR=${MY_PROJECT_DIR}/Header

 export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Analytical
 # export MY_ANALYTICAL_DIR=${MY_ROMS_SRS}/ROMS/Analytical

# Put the binary to execute in the following directory.

 export            BINDIR=${MY_PROJECT_DIR}/Build
